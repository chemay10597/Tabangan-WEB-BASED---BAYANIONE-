...
function submitPostComment($Data){
    ...
    $result = mysql_query("INSERT into comment(post_id,user_id,comment_content,comment_date) values('$post_id','$user_id','$comment_content','$date_created')");
...
function submitWallPost($Data){
    ...
    values('$user_id','$post_type','$post_description','$post_photo','$date_created')");
